[![Build ZMK firmware](https://github.com/alernety/zen-zmk-config/actions/workflows/build.yml/badge.svg)](https://github.com/alernety/zen-zmk-config/actions/workflows/build.yml)
...
Firmware is built automatically via GitHub Actions. Download the latest artifacts from the [Actions tab](https://github.com/alernety/zen-zmk-config/actions).
